# Run the production_weather_etl DAG once (test mode)
...
Write-Host "Running DAG production_weather_etl for execution date $RunDate ..."

airflow dags list-import-errors
airflow dags test production_weather_etl $RunDate
