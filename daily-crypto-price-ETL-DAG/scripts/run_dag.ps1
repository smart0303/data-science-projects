# Run the daily_crypto_prices DAG once (test mode)
...
Write-Host "Running DAG daily_crypto_prices for execution date $RunDate ..."

airflow dags list-import-errors
airflow dags test daily_crypto_prices $RunDate
